...
public class TikiHutDartBlower : MonoBehaviour
{
        ...
        if (!damageable.LockVelocity)
        {
            if (CanMove && touchingDirections.IsGrounded)
                ...
                rb.linearVelocity = new Vector2(
                     Mathf.Clamp(rb.linearVelocity.x + (walkAcceleration * walkDirectionVector.x * Time.fixedDeltaTime), -maxSpeed,
                         maxSpeed), rb.linearVelocity.y);
            else
